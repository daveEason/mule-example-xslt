...
-----------------------------------------------------------------
./src/test/java/com/mulesoft/example/muleexamplexslt/MuleexamplexsltTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/muleexamplexslt-functional-test-config.xml

Defines the Mule configuration for the MuleexamplexsltTestCase.java.
...
artifactId=muleexamplexslt
description=Demonstrates XSLT usage within Mule
muleVersion=3.1.2
